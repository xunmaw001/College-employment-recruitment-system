...
public class ToudiView extends ToudiEntity implements Serializable {
	...
	* 投递状态的值
	*/
	@ColumnInfo(comment="投递状态的字典表值",type="varchar(200)")
	...
	//级联表 简历
		...
		*/
		...
		@ColumnInfo(comment="实习或工作经历",type="longtext")
	...
	//级联表 职位招聘
		...
		*/
		...
		@ColumnInfo(comment="招聘信息详情",type="longtext")
	...
	*/
	...
	public String toString() {
		return "ToudiView{" +
			", toudiYesnoValue=" + toudiYesnoValue +
