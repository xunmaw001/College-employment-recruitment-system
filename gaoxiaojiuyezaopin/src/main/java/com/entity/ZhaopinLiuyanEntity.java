...
public class ZhaopinLiuyanEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public ZhaopinLiuyanEntity() {

	}

	public ZhaopinLiuyanEntity(T t) {
		try {
    ...
    public String toString() {
        return "ZhaopinLiuyan{" +
            ", id=" + id +
            ", zhaopinId=" + zhaopinId +
            ", yonghuId=" + yonghuId +
            ", zhaopinLiuyanText=" + zhaopinLiuyanText +
            ", replyText=" + replyText +
