        ...
        <form class="app-update-pv">
			<view
                ...
                <textarea
                        ...
                        v-model='ruleForm.zhaopinLiuyanText' placeholder="留言内容"></textarea>
            </view>
    ...
    export default {
        ...
        async onLoad(options) {
            ...
            if (options.id) {
                ...
                // 获取信息
                let res = await this.$api.info(`zhaopinLiuyan`, this.ruleForm.id);
        ...
        methods: {
            ...
            async onSubmitTap() {
			if ((!this.ruleForm.zhaopinLiuyanText)) {
                this.$utils.msg(`留言内容不能为空`);
                return
            }
                if (this.ruleForm.id) {
                    await this.$api.update(`zhaopinLiuyan`, this.ruleForm);
                } else {
                    await this.$api.save(`zhaopinLiuyan`, this.ruleForm);
                }
