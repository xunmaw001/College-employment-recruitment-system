<template>
    ...
    <view @tap="onDetailTap('news',item.id)" v-for="(item,index) in newsList" :key="index" class="list-item"
        ...
        <view
                ...
                class="title hide1">{{item.newsName}}</view>
        <view
                ...
                class="category hide2" v-html="item.newsContent">
        </view>
        <view
...
<view class="list-box style4"
    ...
    <view class="list-item">
        <view v-if="zhaopinList.length > 0"
              @tap="onDetailTap('zhaopin',zhaopinList[0].id)" class="box box1"
            ...
            <div
                    ...
                    class="title hide1">{{zhaopinList[0].zhaopinName}}
            </div>
            <image
                    ...
                    :src="baseUrl+zhaopinList[0].zhaopinPhoto">
            </image>
        </view>
        <view class="list-item-body" style="flex: 1;">
            <view v-if="zhaopinList.length > 1"
                  @tap="onDetailTap('zhaopin',zhaopinList[1].id)" class="box box2"
                ...
                <div
                        :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,.3)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"64rpx","fontSize":"28rpx","borderStyle":"solid"}'
                        class="title hide1">{{zhaopinList[1].zhaopinName}}
                </div>
                <image
                        :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"var(--publicSubColor)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx","borderWidth":"8rpx","width":"100%","borderStyle":"solid","height":"100%"}'
                        class="list-item-image" mode="aspectFill"
                        :src="baseUrl+zhaopinList[1].zhaopinPhoto">
                </image>
            </view>
            <view v-if="zhaopinList.length > 2"
                  @tap="onDetailTap('zhaopin',zhaopinList[2].id)" class="box box3"
                ...
                <div
                        :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,.3)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"64rpx","fontSize":"28rpx","borderStyle":"solid"}'
                        class="title hide1">{{zhaopinList[2].zhaopinName}}
                </div>
                <image
                        :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"var(--publicSubColor)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx","borderWidth":"8rpx","width":"100%","borderStyle":"solid","height":"100%"}'
                        class="list-item-image" mode="aspectFill"
                        :src="baseUrl+zhaopinList[2].zhaopinPhoto">
                </image>
            </view>
        </view>
    </view>
    <view class="list-item">
        <view v-if="zhaopinList.length > 3"
              @tap="onDetailTap('zhaopin',zhaopinList[3].id)" class="box box4"
            ...
            <div
                    :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,.3)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"64rpx","fontSize":"28rpx","borderStyle":"solid"}'
                    class="title hide1">{{zhaopinList[3].zhaopinName}}
            </div>
            <image
                    :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"var(--publicSubColor)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx","borderWidth":"8rpx","width":"100%","borderStyle":"solid","height":"100%"}'
                    class="list-item-image" mode="aspectFill"
                    :src="baseUrl+zhaopinList[3].zhaopinPhoto">
            </image>
        </view>
        <view v-if="zhaopinList.length > 4"
              @tap="onDetailTap('zhaopin',zhaopinList[4].id)" class="box box5"
            ...
            <div
                    :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,.3)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"64rpx","fontSize":"28rpx","borderStyle":"solid"}'
                    class="title hide1">{{zhaopinList[4].zhaopinName}}
            </div>
            <image
                    :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"var(--publicSubColor)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx","borderWidth":"8rpx","width":"100%","borderStyle":"solid","height":"100%"}'
                    class="list-item-image" mode="aspectFill"
                    :src="baseUrl+zhaopinList[4].zhaopinPhoto">
            </image>
        </view>
    </view>
    <view v-if="zhaopinList.length > 5"
          @tap="onDetailTap('zhaopin',zhaopinList[5].id)" class="box box6"
        ...
        <div
                :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,.3)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"64rpx","fontSize":"28rpx","borderStyle":"solid"}'
                class="title hide1">{{zhaopinList[5].zhaopinName}}
        </div>
        <image
                :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"var(--publicSubColor)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx","borderWidth":"8rpx","width":"100%","borderStyle":"solid","height":"100%"}'
                class="list-item-image" mode="aspectFill"
                :src="baseUrl+zhaopinList[5].zhaopinPhoto">
        </image>
    </view>
</view>
        ...
        <view class="listBox recommend">
                ...
                <view class="title"
                    ...
                    <text
                            :style='{"padding":"0 20rpx 0 0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"var(--publicSubColor)","color":"rgba(0, 0, 0, 1)","textAlign":"right","borderRadius":"0 20rpx 0 0","borderWidth":"0","width":"45%","lineHeight":"80rpx","fontSize":"28rpx","borderStyle":"solid"}'
                            @tap="onPageTap('gongsi')">查看更多
                    </text>
                </view>
<view class="list-box style4"
      :style='{"padding":"20rpx","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}'>
    <view class="list-item">
        <view v-if="gongsiList.length > 0"
              @tap="onDetailTap('gongsi',gongsiList[0].id)" class="box box1"
              :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0 4% 20rpx 0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"0","borderWidth":"8rpx","width":"48%","borderStyle":"solid","height":"400rpx"}'>
            <div
                    :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,.3)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"64rpx","fontSize":"28rpx","borderStyle":"solid"}'
                    class="title hide1">{{gongsiList[0].gongsiName}}
            </div>
            <image
                    :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"var(--publicSubColor)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx","borderWidth":"8rpx","width":"100%","borderStyle":"solid","height":"100%"}'
                    class="list-item-image" mode="aspectFill"
                    :src="baseUrl+gongsiList[0].gongsiPhoto">
            </image>
        </view>
        <view class="list-item-body" style="flex: 1;">
            <view v-if="gongsiList.length > 1"
                  @tap="onDetailTap('gongsi',gongsiList[1].id)" class="box box2"
                  :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0 0 20rpx","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"190rpx"}'>
                <div
                        :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,.3)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"64rpx","fontSize":"28rpx","borderStyle":"solid"}'
                        class="title hide1">{{gongsiList[1].gongsiName}}
                </div>
                <image
                        :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"var(--publicSubColor)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx","borderWidth":"8rpx","width":"100%","borderStyle":"solid","height":"100%"}'
                        class="list-item-image" mode="aspectFill"
                        :src="baseUrl+gongsiList[1].gongsiPhoto">
                </image>
            </view>
            <view v-if="gongsiList.length > 2"
                  @tap="onDetailTap('gongsi',gongsiList[2].id)" class="box box3"
                  :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"190rpx"}'>
                <div
                        :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,.3)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"64rpx","fontSize":"28rpx","borderStyle":"solid"}'
                        class="title hide1">{{gongsiList[2].gongsiName}}
                </div>
                <image
                        :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"var(--publicSubColor)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx","borderWidth":"8rpx","width":"100%","borderStyle":"solid","height":"100%"}'
                        class="list-item-image" mode="aspectFill"
                        :src="baseUrl+gongsiList[2].gongsiPhoto">
                </image>
            </view>
        </view>
    </view>
    <view class="list-item">
        <view v-if="gongsiList.length > 3"
              @tap="onDetailTap('gongsi',gongsiList[3].id)" class="box box4"
              :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0 4% 20rpx 0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"0","borderWidth":"0","width":"48%","borderStyle":"solid","height":"160rpx"}'>
            <div
                    :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,.3)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"64rpx","fontSize":"28rpx","borderStyle":"solid"}'
                    class="title hide1">{{gongsiList[3].gongsiName}}
            </div>
            <image
                    :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"var(--publicSubColor)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx","borderWidth":"8rpx","width":"100%","borderStyle":"solid","height":"100%"}'
                    class="list-item-image" mode="aspectFill"
                    :src="baseUrl+gongsiList[3].gongsiPhoto">
            </image>
        </view>
        <view v-if="gongsiList.length > 4"
              @tap="onDetailTap('gongsi',gongsiList[4].id)" class="box box5"
              :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0 0 20rpx 0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"0","borderWidth":"0","width":"48%","borderStyle":"solid","height":"160rpx"}'>
            <div
                    :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,.3)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"64rpx","fontSize":"28rpx","borderStyle":"solid"}'
                    class="title hide1">{{gongsiList[4].gongsiName}}
            </div>
            <image
                    :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"var(--publicSubColor)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx","borderWidth":"8rpx","width":"100%","borderStyle":"solid","height":"100%"}'
                    class="list-item-image" mode="aspectFill"
                    :src="baseUrl+gongsiList[4].gongsiPhoto">
            </image>
        </view>
    </view>
    <view v-if="gongsiList.length > 5"
          @tap="onDetailTap('gongsi',gongsiList[5].id)" class="box box6"
          :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"160rpx"}'>
        <div
                :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,.3)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"64rpx","fontSize":"28rpx","borderStyle":"solid"}'
                class="title hide1">{{gongsiList[5].gongsiName}}
        </div>
        <image
                :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"var(--publicSubColor)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx","borderWidth":"8rpx","width":"100%","borderStyle":"solid","height":"100%"}'
                class="list-item-image" mode="aspectFill"
                :src="baseUrl+gongsiList[5].gongsiPhoto">
        </image>
    </view>
</view>
...
<script>
    ...
    export default {
        ...
        async onShow() {
            ...
            let zhaopin = await this.$api.list('zhaopin', {
                page: 1,
                limit: 6,
                });

            this.zhaopinList = zhaopin.data.list
            this.zhaopinList.forEach(function(item, index) {
            ...
            let gongsi = await this.$api.list('gongsi', {
                page: 1,
                limit: 6,
                });

            this.gongsiList = gongsi.data.list
            this.gongsiList.forEach(function(item, index) {
