        ...
        <form class="app-update-pv">
            <view
                ...
                <input   disabled
                         ...
                         :disabled="ro.newsName" type="text" v-model="ruleForm.newsName" placeholder="公告信息标题"></input>
            </view>
            ...
            <view
                ...
                <textarea :style='{"padding":"0 30rpx","boxShadow":"0 0 0px rgba(0,0,0,.6) inset","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"var(--publicSubColor)","color":"#fff","textAlign":"left","borderRadius":"20rpx 0","borderWidth":"0 10rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx","height":"200rpx"}'
                          :disabled="ro.newsContent" v-model="ruleForm.newsContent" placeholder="公告信息详情"/>
            </view>
        ...
        methods: {
            ...
            async onSubmitTap() {
				if ((!this.ruleForm.newsName)) {
                    this.$utils.msg(`公告信息标题不能为空`);
                    return
                }
				if ((!this.ruleForm.newsPhoto)) {
                    this.$utils.msg(`公告信息图片不能为空`);
                    return
                }
                if (this.ruleForm.id) {
