<template>
    <view class="content">
        <view class="box"
              :style='{"padding":"48rpx","boxShadow":"0 0 0px #59f43e","margin":"0 auto","backgroundColor":"rgba(255, 255, 255, 0.5)","borderColor":"#ccc","borderRadius":"0","borderWidth":"0","width":"96%","borderStyle":"solid","height":"auto"}'>
            ...
            <button class="landing"
                    :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"var(--publicMainColor)","borderRadius":"1800rpx 1800rpx 40rpx 40rpx","color":"rgba(255, 255, 255, 1)","borderWidth":"0","width":"100%","fontSize":"40rpx","borderStyle":"solid","height":"200rpx"}'
...
<style>
    ...
    .content:after {
        ...
        bottom: 0;
        content: '';
        background-image: url(http://localhost:8080/gaoxiaojiuyezaopin/img/front-img-bg.jpg);
